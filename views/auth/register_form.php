        ...
        <div class="card shadow-sm border-0 rounded-4 p-4" style="background: var(--glass-bg); border: 1px solid var(--glass-border);">
            ...
            <form action="register.php" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" class="form-control form-control-lg bg-transparent text-reset" required>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-dark w-100 btn-lg rounded-pill mb-3">Registrarse</button>
            </form>
            
            <div class="text-center">
                <small class="text-muted">¿Ya tienes cuenta? <a href="login.php" class="text-reset fw-bold">Inicia sesión</a></small>
            </div>
        </div>
    </div>
</div>